...
closed_invoices = df_invoice_to_customer[df_invoice_to_customer['Invoice Status'] == 'Void']
...
axs[0].set_title('Top 20 Customers by Invoice Amount (Void Invoices)')
...
axs[1].set_title('Top 20 Customers by Order Count (Void Invoices)')
